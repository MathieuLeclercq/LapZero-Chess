...
import numpy.typing
import typing
__all__: list[str] = ['BISHOP', 'BLACK', 'CHECKMATE', 'Chessboard', 'Color', 'DRAW_50_MOVES', 'DRAW_INSUFF_MATERIAL', 'DRAW_REPETITION', 'GameResult', 'GameState', 'KING', 'KNIGHT', 'MCTS', 'Move', 'MoveStats', 'NONE', 'NO_COLOR', 'ONGOING', 'ONNXEvaluator', 'PAWN', 'Piece', 'PieceType', 'QUEEN', 'ROOK', 'STALEMATE', 'SearchCounters', 'Square', 'TreeReport', 'WHITE', 'generate_self_play_games']
class Chessboard:
...
class MCTS:
    ...
    def inspect_tree(self) -> TreeReport:
        ...
    def mcts_search(self, board: Chessboard, num_simulations: typing.SupportsInt | typing.SupportsIndex, c_puct: typing.SupportsFloat | typing.SupportsIndex = 1.399999976158142, add_dirichlet: bool = False, batch_size: typing.SupportsInt | typing.SupportsIndex = 0) -> list[float]:
        ...
    def reset_analysis(self) -> None:
        ...
    def reset_counters(self) -> None:
        ...
    def step_analysis(self, board: Chessboard, num_simulations: typing.SupportsInt | typing.SupportsIndex, c_puct: typing.SupportsFloat | typing.SupportsIndex = 1.399999976158142, batch_size: typing.SupportsInt | typing.SupportsIndex = 0) -> None:
        ...
