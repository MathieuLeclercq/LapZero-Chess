...
class Chessboard:
    ...
    def get_board_history(self) -> list[typing.Annotated[list[Square], "FixedSize(64)"]]:
        ...
    def get_evaluation_cache_key(self, history_depth: typing.SupportsInt | typing.SupportsIndex) -> EvaluationCacheKey:
        ...
    ...
    def move_piece_uci(self, arg0: str) -> bool:
        ...
    def set_amnesia_mode(self, amnesia: bool) -> None:
        ...
...
class EvaluationCacheKey:
    ...
    def combined_hash(self) -> int:
        ...
    @property
    def current_context_hash(self) -> int:
        ...
    @property
    def half_move_clock(self) -> int:
        ...
    @property
    def history_hash(self) -> int:
        ...
    @property
    def position_hash(self) -> int:
        ...
    @property
    def repetition_category(self) -> int:
        ...
    @property
    def total_moves_bucket(self) -> int:
        ...
class GameResult:
    @property
...
class MCTS:
    ...
    def get_counters(self) -> SearchCounters:
        ...
    def get_last_timing(self) -> SearchTiming:
        ...
...
class SearchCounters:
    ...
    def nn_calls(self) -> int:
        ...
    @property
    def terminal_hits(self) -> int:
        ...
    @property
    def tt_context_rejects(self) -> int:
        ...
    @property
    def tt_history_rejects(self) -> int:
        ...
    @property
    ...
    def tt_misses(self) -> int:
        ...
    @property
    def tt_position_matches(self) -> int:
        ...
    @property
    def tt_rule50_rejects(self) -> int:
        ...
    @property
    def waves(self) -> int:
        ...
class SearchTiming:
    @property
    def backup_ns(self) -> int:
        ...
    @property
    def batch_assembly_ns(self) -> int:
        ...
    @property
    def board_copy_ns(self) -> int:
        ...
    @property
    def enabled(self) -> bool:
        ...
    @property
    def evaluator_ns(self) -> int:
        ...
    @property
    def expansion_ns(self) -> int:
        ...
    @property
    def selection_ns(self) -> int:
        ...
    @property
    def tensor_key_ns(self) -> int:
        ...
    @property
    def tt_probe_store_ns(self) -> int:
        ...
    @property
    def tt_wait_ns(self) -> int:
        ...
    @property
