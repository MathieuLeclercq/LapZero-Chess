...
class GameState:
    ...
    def value(self) -> int:
        ...
class MCTS:
    def __init__(self, evaluator: ONNXEvaluator, tt_size: typing.SupportsInt | typing.SupportsIndex = 2097143, cache_history_depth: typing.SupportsInt | typing.SupportsIndex = 1) -> None:
        ...
