...
2026-09-22 20:09 : [MCTS] Rebalayage après R1 : virtual loss 2 gagne 9 à 20 % de débit, abaisse le p95 de latence de 13 à 20 % et passe la barrière qualité sur 2500 puzzles, IC95 [-0,4 ; +0,56]. Le rejet de septembre venait de la fuite R1, pas du réglage ; il est activé dans le bot, le self-play, le tournoi, la GUI et l'ancrage.
